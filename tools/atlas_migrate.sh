...
# ES index name
ES_INDEX="${ES_INDEX:-janusgraph_vertex_index}"
...
# Auto-generated by run-migrator.sh at $(date)
...
target.elasticsearch.index=${ES_INDEX}
...
migration.writer.batch.size=${BATCH_SIZE}
...
show_help() {
    ...
    echo "  ES_INDEX               ES index name (default: janusgraph_vertex_index)"
