...
public class CassandraGraphTest {
    ...
    public void testIsPropertyValueConversionNeeded() {
        assertFalse(graph.isPropertyValueConversionNeeded(null));
    }

    @Test
    public void testGetSupportedGremlinVersion() {
        assertEquals(graph.getSupportedGremlinVersion(), GremlinVersion.THREE);
    }

    @Test
    public void testRequiresInitialIndexedPredicate() {
        assertFalse(graph.requiresInitialIndexedPredicate());
    }

    @Test(expectedExceptions = AtlasBaseException.class)
    public void testGetGremlinScriptEngineThrows() throws AtlasBaseException {
        graph.getGremlinScriptEngine();
    }

    @Test
    public void testReleaseGremlinScriptEngineNoOp() {
        graph.releaseGremlinScriptEngine(null); // should not throw
    }

    @Test(expectedExceptions = AtlasBaseException.class)
    public void testExecuteGremlinScriptThrows() throws AtlasBaseException {
