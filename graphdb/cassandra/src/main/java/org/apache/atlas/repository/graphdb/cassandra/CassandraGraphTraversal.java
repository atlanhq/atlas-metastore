...
/**
 * Minimal graph traversal implementation for Cassandra backend.
 * Replaces Gremlin traversals with direct vertex/edge queries.
 *
 * Note: This extends AtlasGraphTraversal which currently extends TinkerPop's DefaultGraphTraversal.
 * That base class dependency will be removed in a follow-up refactor of graphdb-api.
 */
public class CassandraGraphTraversal extends AtlasGraphTraversal<AtlasVertex, AtlasEdge> {
    ...
    @Override
    public AtlasGraphTraversal textContainsRegEx(String value, String removeRedundantQuotes) {
        return this;
    }
