...
public class MigratorMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            if (validateOnly) {
                ...
                runFullMigration(config, metrics, sourceSession, targetSession, stateStore);
            }
        } finally {
            sourceSession.close();
            targetSession.close();
    ...
    private static void runFullMigration(MigratorConfig config, MigrationMetrics metrics,
                                          ...
                                          MigrationStateStore stateStore) throws Exception {
        metrics.start();
        ...
        try {
            // ========== Phase 1: Scan + Write ==========
            LOG.info("=== Phase 1: Scan JanusGraph edgestore + Write to target ===");
            ...
            // Signal completion and wait for writers to drain the queue
