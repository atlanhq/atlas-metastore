...
public class AuthPolicyValidator {
    ...
    private static final Map<String, Set<String>> PERSONA_POLICY_VALID_ACTIONS = new HashMap<String, Set<String>>(){{
        ...
        put(POLICY_SERVICE_NAME_HEKA + POLICY_SUB_CATEGORY_METADATA, PERSONA_METADATA_POLICY_ACTIONS);
        put(POLICY_SERVICE_NAME_HEKA + POLICY_SUB_CATEGORY_DATA, DATA_POLICY_ACTIONS);
        put(POLICY_SERVICE_NAME_HEKA + POLICY_SUB_CATEGORY_GLOSSARY, PERSONA_GLOSSARY_POLICY_ACTIONS);
        put(POLICY_SERVICE_NAME_HEKA + POLICY_SUB_CATEGORY_AI, AI_POLICY_ACTIONS);
