...
public class AtlasGraphUtilsV2 {
    ...
    public static AtlasVertex findByGuid(AtlasGraph graph, String guid) {
        MetricRecorder metric = RequestContext.get().startMetricRecord("findByGuid");
    ...
    public static Status getState(AtlasElement element) {
        String state = getStateAsString(element);
        return state == null ? null : Status.valueOf(state);
    }
