...
public class CassandraConfig {
    ...
    public CqlSession cqlSession() throws AtlasException {
        ...
        String keyspace = ApplicationProperties.get().getString(CASSANDRA_NEW_KEYSPACE_PROPERTY, "atlandata");
        int bucketPower = ApplicationProperties.get().getInt(CASSANDRA_BUCKET_POWER, 6);
