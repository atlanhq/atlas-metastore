...
public class MigrationImport extends ImportStrategy {
    ...
    private AtlasEntityStoreV2 createEntityStore(AtlasGraph graph, AtlasTypeRegistry typeRegistry) {
        ...
        EntityGraphMapperV3 entityGraphMapperV3 = new EntityGraphMapperV3(deleteDelegate, restoreHandlerV1, typeRegistry,
        ...
        return new AtlasEntityStoreV2(graph, deleteDelegate, restoreHandlerV1, typeRegistry, entityChangeNotifier, entityGraphMapperV3, null, atlasRelationshipStoreV2, null, null, null);
    }
