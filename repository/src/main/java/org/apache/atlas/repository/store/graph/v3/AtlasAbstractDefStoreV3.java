 ...
 */
  abstract class AtlasAbstractDefStoreV3<T extends AtlasBaseTypeDef> implements AtlasDefStore<T> {
    private static final Logger LOG = LoggerFactory.getLogger(AtlasAbstractDefStoreV3.class);
    ...
    public AtlasAbstractDefStoreV3(AtlasTypeDefGraphStoreV2 typeDefStore, AtlasTypeRegistry typeRegistry) {
