 ...
 */
public class AtlasEntityDefStoreV3 extends AtlasAbstractDefStoreV3<AtlasEntityDef> {
    private static final Logger LOG = LoggerFactory.getLogger(AtlasEntityDefStoreV3.class);

    @Inject
    public AtlasEntityDefStoreV3(AtlasTypeDefGraphStoreV2 typeDefStore, AtlasTypeRegistry typeRegistry) {
