...
public final class GraphHelper {
    ...
    public AtlasEdge addClassificationEdge(AtlasVertex entityVertex, AtlasVertex classificationVertex, String tagTypeName, boolean isPropagated) throws AtlasBaseException {
        AtlasEdge ret = addEdge(entityVertex, classificationVertex, CLASSIFICATION_LABEL);
