...
import org.apache.atlas.repository.store.graph.v3.preprocessor.AssetPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.AuthPolicyPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.ConnectionPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.accesscontrol.PersonaPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.accesscontrol.PurposePreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.accesscontrol.StakeholderPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.contract.ContractPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.datamesh.DataDomainPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.datamesh.DataProductPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.datamesh.StakeholderTitlePreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.glossary.CategoryPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.glossary.GlossaryPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.glossary.TermPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.resource.LinkPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.resource.ReadmePreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.sql.QueryCollectionPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.sql.QueryFolderPreProcessor;
import org.apache.atlas.repository.store.graph.v3.preprocessor.sql.QueryPreProcessor;
import org.apache.atlas.repository.store.graph.v3.tasks.MeaningsTask;
...
public class AtlasEntityStoreV2 implements AtlasEntityStore {
    ...
    private AtlasEntityHeader getAtlasEntityHeader(String entityGuid, String entityId, String entityType) throws AtlasBaseException {
        // Metric logs
        MetricRecorder metric = RequestContext.get().startMetricRecord("getAtlasEntityHeader");
        ...
        for (AtlasEvaluatePolicyRequest entity : entities) {
            ...
            if (ENTITY_READ.name().equals(action) || ENTITY_CREATE.name().equals(action) || ENTITY_UPDATE.name().equals(action)
                ...
                try {
                    ...
                    AtlasEntityAccessRequestBuilder requestBuilder = new AtlasEntityAccessRequestBuilder(typeRegistry, AtlasPrivilege.valueOf(entity.getAction()), entityHeader);
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(context.getUpdatedEntities())) {
                ...
                for (AtlasEntity entity : context.getUpdatedEntities()) {
                    if (entity.getStatus() == Status.DELETED) {// entity status could be updated during import
                        continue;
                    }
    ...
    private void checkAndCreateProcessRelationshipsCleanupTaskNotification(AtlasEntityType entityType, AtlasVertex vertex) {
        MetricRecorder metric = RequestContext.get().startMetricRecord("checkAndCreateAtlasDistributedTaskNotification");
        try {
...
//            }
    ...
    public void repairHasLineage(AtlasHasLineageRequests requests) throws AtlasBaseException {
        MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("repairHasLineage");
    ...
    private void repairHasLineageForAsset(AtlasHasLineageRequest request) {
        ...
        MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("repairHasLineageForAssetGetById");
    ...
    public void repairHasLineageWithAtlasEdges(Set<AtlasEdge> inputOutputEdges) {
        MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("repairHasLineageWithAtlasEdges");
    ...
    public void repairMeaningAttributeForTerms(List<String> termGuid) {
        ...
        for (String guid : termGuid) {
            ...
            if(termVertex!= null && ATLAS_GLOSSARY_TERM_ENTITY_TYPE.equals(getTypeName(termVertex)) &&
                    GraphHelper.getStatus(termVertex) == Status.ACTIVE) {
                ...
                if (edges != null) {
                    for (Iterator<AtlasEdge> iter = edges.iterator(); iter.hasNext(); ) {
                        ...
                        if (GraphHelper.getStatus(edge) == Status.ACTIVE) {
                            AtlasVertex entityVertex = edge.getInVertex();
                            if (entityVertex != null & getStatus(entityVertex) == Status.ACTIVE) {
        ...
        if (edges != null) {
            for (Iterator<AtlasEdge> iter = edges.iterator(); iter.hasNext(); ) {
                ...
                if (GraphHelper.getStatus(edge) == Status.ACTIVE) {
                    ...
                    if (termVertex != null & getStatus(termVertex) == Status.ACTIVE) {
    ...
    public void repairAccesscontrolAlias(String guid) throws AtlasBaseException {
        MetricRecorder metric = RequestContext.get().startMetricRecord("repairAlias");
    ...
    public void linkBusinessPolicy(List<BusinessPolicyRequest.AssetComplianceInfo> data) throws AtlasBaseException {
        MetricRecorder metric = RequestContext.get().startMetricRecord("linkBusinessPolicy.GraphTransaction");
    ...
    public void unlinkBusinessPolicy(String policyGuid, Set<String> unlinkGuids) throws AtlasBaseException {
        MetricRecorder metric = RequestContext.get().startMetricRecord("unlinkBusinessPolicy.GraphTransaction");
        try {
    ...
    public void linkMeshEntityToAssets(String meshEntityGuid, Set<String> linkGuids) throws AtlasBaseException {
        MetricRecorder metric = RequestContext.get().startMetricRecord("linkMeshEntityToAssets.GraphTransaction");
    ...
    public void unlinkMeshEntityFromAssets(String meshEntityGuid, Set<String> unlinkGuids) throws AtlasBaseException {
        MetricRecorder metric = RequestContext.get().startMetricRecord("unlinkMeshEntityFromAssets.GraphTransaction");
        try {
    ...
    private void handleEntityMutation(List<AtlasVertex> vertices) throws AtlasBaseException {
        MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("handleEntityMutation");
    ...
    public void moveBusinessPolicies(Set<String> policyIds, String assetId, String type) throws AtlasBaseException {
        ...
        MetricRecorder metric = RequestContext.get().startMetricRecord("moveBusinessPolicy.GraphTransaction");
