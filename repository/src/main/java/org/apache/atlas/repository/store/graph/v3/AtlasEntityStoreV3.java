...
@Component
public class AtlasEntityStoreV3 implements AtlasEntityStore {
    ...
    @Inject
    public AtlasEntityStoreV3(AtlasGraph graph, DeleteHandlerDelegate deleteDelegate, RestoreHandlerV1 restoreHandlerV1, AtlasTypeRegistry typeRegistry,
