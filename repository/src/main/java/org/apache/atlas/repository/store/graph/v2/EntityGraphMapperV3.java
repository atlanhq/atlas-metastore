...
@Component
public class EntityGraphMapperV3 {
    private static final Logger LOG      = LoggerFactory.getLogger(EntityGraphMapperV3.class);
    private static final Logger PERF_LOG = AtlasPerfTracer.getPerfLogger("entityGraphMapperV3");
    ...
    private final EntityGraphRetrieverV3 retrieverNoRelation;
    ...
    @Inject
    public EntityGraphMapperV3(DeleteHandlerDelegate deleteDelegate, RestoreHandlerV1 restoreHandlerV1, AtlasTypeRegistry typeRegistry, AtlasGraph graph,
    ...
    public AtlasVertex createShellEntityVertex(AtlasObjectId objectId, EntityGraphDiscoveryContext context) throws AtlasBaseException {
        ...
        for (String superTypeName : entityType.getAllSuperTypes()) {
            AtlasGraphUtilsV3.addEncodedProperty(ret, SUPER_TYPES_PROPERTY_KEY, superTypeName);
        }

        AtlasGraphUtilsV3.setEncodedProperty(ret, GUID_PROPERTY_KEY, guid);
        AtlasGraphUtilsV3.setEncodedProperty(ret, VERSION_PROPERTY_KEY, getEntityVersion(null));
        AtlasGraphUtilsV3.setEncodedProperty(ret, IS_INCOMPLETE_PROPERTY_KEY, INCOMPLETE_ENTITY_VALUE);
    ...
    public AtlasVertex createVertexWithGuid(AtlasEntity entity, String guid) throws AtlasBaseException {
        ...
        AtlasGraphUtilsV3.setEncodedProperty(ret, GUID_PROPERTY_KEY, guid);
        AtlasGraphUtilsV3.setEncodedProperty(ret, VERSION_PROPERTY_KEY, getEntityVersion(entity));
    ...
    public void updateSystemAttributes(AtlasVertex vertex, AtlasEntity entity) throws AtlasBaseException {
        if (entity.getVersion() != null) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, VERSION_PROPERTY_KEY, entity.getVersion());
        }

        if (entity.getCreateTime() != null) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, TIMESTAMP_PROPERTY_KEY, entity.getCreateTime().getTime());
        }

        if (entity.getUpdateTime() != null) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, MODIFICATION_TIMESTAMP_PROPERTY_KEY, entity.getUpdateTime().getTime());
        }

        if (StringUtils.isNotEmpty(entity.getCreatedBy())) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, CREATED_BY_KEY, entity.getCreatedBy());
        }

        if (StringUtils.isNotEmpty(entity.getUpdatedBy())) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, MODIFIED_BY_KEY, entity.getUpdatedBy());
        }

        if (StringUtils.isNotEmpty(entity.getHomeId())) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, HOME_ID_KEY, entity.getHomeId());
        }

        if (entity.isProxy() != null) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, IS_PROXY_KEY, entity.isProxy());
        }

        if (entity.getProvenanceType() != null) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, PROVENANCE_TYPE_KEY, entity.getProvenanceType());
        }
    ...
    private void setSystemAttributesToEntity(AtlasVertex entityVertex, AtlasEntity createdEntity) {
        ...
        createdEntity.setCreatedBy(GraphHelperV3.getCreatedByAsString(entityVertex));
        createdEntity.setUpdatedBy(GraphHelperV3.getModifiedByAsString(entityVertex));
        createdEntity.setCreateTime(new Date(GraphHelperV3.getCreatedTime(entityVertex)));
        createdEntity.setUpdateTime(new Date(GraphHelperV3.getModifiedTime(entityVertex)));
    ...
    public void setCustomAttributes(AtlasVertex vertex, AtlasEntity entity) {
        ...
        if (customAttributesString != null) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, CUSTOM_ATTRIBUTES_PROPERTY_KEY, customAttributesString);
        }
    }
    ...
    public void mapGlossaryRelationshipAttribute(AtlasAttribute attribute, AtlasObjectId glossaryObjectId,
        ...
        mapAttribute(attribute, glossaryObjectId, entityVertex, EntityOperation.UPDATE, context);
    }
    ...
    public void setLabels(AtlasVertex vertex, Set<String> labels) throws AtlasBaseException {
        ...
        entityChangeNotifier.onLabelsUpdatedFromEntity(graphHelperV3.getGuid(vertex), addedLabels, removedLabels);
    }

    public void addLabels(AtlasVertex vertex, Set<String> labels) throws AtlasBaseException {
        if (CollectionUtils.isNotEmpty(labels)) {
            final Set<String> existingLabels = graphHelperV3.getLabels(vertex);
            ...
            if (!updatedLabels.equals(existingLabels)) {
                ...
                entityChangeNotifier.onLabelsUpdatedFromEntity(graphHelperV3.getGuid(vertex), updatedLabels, null);
            }
        }
    }
        ...
        if (CollectionUtils.isNotEmpty(labels)) {
            ...
            if (CollectionUtils.isNotEmpty(existingLabels)) {
                ...
                if (!updatedLabels.equals(existingLabels)) {
                    ...
                    entityChangeNotifier.onLabelsUpdatedFromEntity(graphHelperV3.getGuid(vertex), null, existingLabels);
                }
            }
        }
    }
    ...
    public void setBusinessAttributes(AtlasVertex entityVertex, AtlasEntityType entityType, Map<String, Map<String, Object>> businessAttributes) throws AtlasBaseException {
        ...
        if (MapUtils.isNotEmpty(updatedBusinessAttributes)) {
            ...
            entityChangeNotifier.onBusinessAttributesUpdated(getIdFromVertex(entityVertex), updatedBusinessAttributes);
        }
    ...
    private AtlasVertex createStructVertex(String typeName) {
        ...
        AtlasGraphUtilsV3.setEncodedProperty(ret, ENTITY_TYPE_PROPERTY_KEY, typeName);
        AtlasGraphUtilsV3.setEncodedProperty(ret, STATE_PROPERTY_KEY, AtlasEntity.Status.ACTIVE.name());
        AtlasGraphUtilsV3.setEncodedProperty(ret, TIMESTAMP_PROPERTY_KEY, RequestContext.get().getRequestTime());
        AtlasGraphUtilsV3.setEncodedProperty(ret, MODIFICATION_TIMESTAMP_PROPERTY_KEY, RequestContext.get().getRequestTime());
        AtlasGraphUtilsV3.setEncodedProperty(ret, CREATED_BY_KEY, RequestContext.get().getUser());
        AtlasGraphUtilsV3.setEncodedProperty(ret, MODIFIED_BY_KEY, RequestContext.get().getUser());
    ...
    private AtlasVertex createClassificationVertex(AtlasClassification classification) {
        ...
        AtlasGraphUtilsV3.addEncodedProperty(ret, SUPER_TYPES_PROPERTY_KEY, classificationType.getAllSuperTypes());
        AtlasGraphUtilsV3.setEncodedProperty(ret, CLASSIFICATION_ENTITY_GUID, classification.getEntityGuid());
        AtlasGraphUtilsV3.setEncodedProperty(ret, CLASSIFICATION_ENTITY_STATUS, classification.getEntityStatus().name());
    ...
    private void mapAttributes(AtlasStruct struct, AtlasStructType structType, AtlasVertex vertex, EntityOperation op, EntityMutationContext context) throws AtlasBaseException {
        ...
        if (MapUtils.isNotEmpty(struct.getAttributes())) {
                ...
                for (String attrName : struct.getAttributes().keySet()) {
                    ...
                    if (attribute != null) {
                        ...
                        if (isArrayOfPrimitiveType || isArrayOfEnum) {
                            ...
                            String edgeLabel = AtlasGraphUtilsV3.getEdgeLabel(attribute.getName());
            ...
            graphHelperV3.updateMetadataAttributes(vertex, timestampAutoUpdateAttributes, "timestamp");
            graphHelperV3.updateMetadataAttributes(vertex, userAutoUpdateAttributes, "user");
    ...
    private void mapAttribute(AtlasAttribute attribute, Object attrValue, AtlasVertex vertex, EntityOperation op, EntityMutationContext context, boolean isAppendOp, boolean isRemoveOp) throws AtlasBaseException {
        MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("mapAttribute");
        try {
    ...
    private Object mapToVertexByTypeCategory(AttributeMutationContext ctx, EntityMutationContext context, boolean isAppendOp, boolean isRemoveOp) throws AtlasBaseException {
        MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("mapToVertexByTypeCategory");
        ...
        try {
            ...
            switch (ctx.getAttrType().getTypeCategory()) {
                ...
                case STRUCT: {
                    String    edgeLabel   = AtlasGraphUtilsV3.getEdgeLabel(ctx.getVertexProperty());
                    AtlasEdge currentEdge = graphHelperV3.getEdgeForLabel(ctx.getReferringVertex(), edgeLabel);
                ...
                case OBJECT_ID_TYPE: {
                    ...
                    if (StringUtils.isEmpty(edgeLabel)) {
                        edgeLabel = AtlasGraphUtilsV3.getEdgeLabel(ctx.getVertexProperty());
                    }
                    ...
                    if (StringUtils.isNotEmpty(relationshipGuid) && !RequestContext.get().isImportInProgress()) {
                        currentEdge = graphHelperV3.getEdgeForGUID(relationshipGuid);
                    } else {
                        currentEdge = graphHelperV3.getEdgeForLabel(ctx.getReferringVertex(), edgeLabel, edgeDirection);
                    }
    ...
    private Object mapSoftRefValueWithUpdate(AttributeMutationContext ctx, EntityMutationContext context) {
        ...
        AtlasGraphUtilsV3.setProperty(ctx.getReferringVertex(), ctx.getVertexProperty(), softRefValue);
    ...
    private void addInverseReference(EntityMutationContext context, AtlasAttribute inverseAttribute, AtlasEdge edge, Map<String, Object> relationshipAttributes) throws AtlasBaseException {
        ...
        AtlasEdge       inverseEdge      = graphHelperV3.getEdgeForLabel(inverseVertex, inverseEdgeLabel);
        String          propertyName     = AtlasGraphUtilsV3.getQualifiedAttributePropertyKey(inverseType, inverseAttribute.getName());
        ...
        if (inverseUpdated) {
            ...
            if (!requestContext.isDeletedEntity(graphHelperV3.getGuid(inverseVertex))) {
    ...
    private AtlasEdge createInverseReferenceUsingRelationship(EntityMutationContext context, AtlasAttribute inverseAttribute, AtlasEdge edge, Map<String, Object> relationshipAttributes) throws AtlasBaseException {
        ...
        if (inverseAttributeType instanceof AtlasEntityType) {
            ...
            if (entityType.hasRelationshipAttribute(inverseAttributeName)) {
                String relationshipName = graphHelperV3.getRelationshipTypeName(inverseVertex, entityType, inverseAttributeName);
                ...
                if (LOG.isDebugEnabled()) {
                    LOG.debug("No RelationshipDef defined between {} and {} on attribute: {}", inverseAttributeType,
                            AtlasGraphUtilsV3.getTypeName(vertex), inverseAttributeName);
                }
    ...
    private void updateRelationshipGuidForImport(EntityMutationContext context, String inverseAttributeName, AtlasVertex inverseVertex, AtlasEdge edge) throws AtlasBaseException {
        ...
        String parentGuid = graphHelperV3.getGuid(inverseVertex);
        ...
        AtlasGraphUtilsV3.setEncodedProperty(edge, RELATIONSHIP_GUID_PROPERTY_KEY, parentRelationshipGuid);
    }
    ...
    private AtlasEdge createInverseReference(AtlasAttribute inverseAttribute, AtlasStructType inverseAttributeType,
        ...
        String propertyName     = AtlasGraphUtilsV3.getQualifiedAttributePropertyKey(inverseAttributeType, inverseAttribute.getName());
        String inverseEdgeLabel = AtlasGraphUtilsV3.getEdgeLabel(propertyName);
        AtlasEdge ret;

        try {
            ret = graphHelperV3.getOrCreateEdge(inverseVertex, vertex, inverseEdgeLabel);
    ...
    private Object mapPrimitiveValue(AtlasVertex vertex, AtlasAttribute attribute, Object valueFromEntity, boolean isDeletedEntity) {
        ...
        AtlasGraphUtilsV3.setEncodedProperty(vertex, attribute.getVertexPropertyName(), ret);

        String uniqPropName = attribute != null ? attribute.getVertexUniquePropertyName() : null;

        if (uniqPropName != null) {
            // Removing AtlasGraphUtilsV3.getState(vertex) == DELETED condition below to keep the unique contrain even if asset is deleted.
            if (isDeletedEntity) {
                vertex.removeProperty(uniqPropName);
            } else {
                AtlasGraphUtilsV3.setEncodedProperty(vertex, uniqPropName, ret);
            }
        }
    ...
    private AtlasEdge mapObjectIdValue(AttributeMutationContext ctx, EntityMutationContext context) throws AtlasBaseException {
        ...
        if (ctx.getCurrentEdge() != null) {
            ...
            try {
                ret = graphHelperV3.getOrCreateEdge(ctx.getReferringVertex(), entityVertex, edgeLabel);
            } catch (RepositoryException e) {
                throw new AtlasBaseException(AtlasErrorCode.INTERNAL_ERROR, e);
            }
        }
    ...
    private AtlasEdge mapObjectIdValueUsingRelationship(AttributeMutationContext ctx, EntityMutationContext context) throws AtlasBaseException {
        MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("mapObjectIdValueUsingRelationship");
        try {
            if (LOG.isDebugEnabled()) {
            ...
            AtlasType type = typeRegistry.getType(AtlasGraphUtilsV3.getTypeName(entityVertex));
                ...
                if (entityType.hasRelationshipAttribute(attributeName)) {
                    ...
                    if (ctx.getCurrentEdge() != null && getStatus(ctx.getCurrentEdge()) != DELETED) {
                        ...
                        if (StringUtils.isEmpty(relationshipName)) {
                            relationshipName = graphHelperV3.getRelationshipTypeName(entityVertex, entityType, attributeName);
                        }
                        ...
                        boolean isCreated = graphHelperV3.getCreatedTime(ret) == RequestContext.get().getRequestTime();
                        ...
                        if (RequestContext.get().isImportInProgress()) {
                            ...
                            if(!StringUtils.isEmpty(relationshipGuid)) {
                                AtlasGraphUtilsV3.setEncodedProperty(ret, RELATIONSHIP_GUID_PROPERTY_KEY, relationshipGuid);
                            }
                        }
                    }
                } else {
        ...
        if (type instanceof AtlasEntityType) {
            ...
            if (entityType.hasRelationshipAttribute(attributeName)) {
                ...
                if (createEdge) {
                    ...
                    boolean isCreated = graphHelperV3.getCreatedTime(edge) == RequestContext.get().getRequestTime();
    ...
    public List mapArrayValue(AttributeMutationContext ctx, EntityMutationContext context) throws AtlasBaseException {
        ...
        for (int index = 0; allArrayElements != null && index < allArrayElements.size(); index++) {
            ...
            if ((element instanceof AtlasEdge)) {
                ...
                if ((removedElements.contains(element)) && ((EDGE_LABELS_FOR_HARD_DELETION).contains(edge.getLabel()))) {
                    ...
                    AtlasGraphUtilsV3.setEncodedProperty((AtlasEdge) element, ATTRIBUTE_INDEX_PROPERTY_KEY, index);
                }
            }
        }
        ...
        switch (ctx.getAttribute().getRelationshipEdgeLabel()) {
            ...
            case PROCESS_INPUTS:
            case PROCESS_OUTPUTS: addEdgesToContext(GraphHelperV3.getGuid(ctx.referringVertex), newElementsCreated,  removedElements);
                break;
    ...
    public List appendArrayValue(AttributeMutationContext ctx, EntityMutationContext context) throws AtlasBaseException {
        ...
        switch (ctx.getAttribute().getRelationshipEdgeLabel()) {
            ...
            case PROCESS_INPUTS:
            case PROCESS_OUTPUTS: addEdgesToContext(GraphHelperV3.getGuid(ctx.referringVertex), newElementsCreated,  new ArrayList<>(0));
                break;
    ...
    public List removeArrayValue(AttributeMutationContext ctx, EntityMutationContext context) throws AtlasBaseException {
        ...
        for (int index = 0; index < elementsDeleted.size(); index++) {
            ...
            if (deleteEntry == null) {
                ...
                throw new AtlasBaseException(AtlasErrorCode.RELATIONSHIP_DOES_NOT_EXIST, attribute.getRelationshipName(),
                        getIdFromVertex(attributeVertex), getIdFromVertex(ctx.getReferringVertex()));
            }
        ...
        switch (ctx.getAttribute().getRelationshipEdgeLabel()) {
            ...
            case PROCESS_INPUTS:
            case PROCESS_OUTPUTS: addEdgesToContext(GraphHelperV3.getGuid(ctx.referringVertex), new ArrayList<>(0),  removedElements);
                break;
    ...
    private void addOrRemoveDaapInternalAttr(AtlasVertex toVertex, String internalAttr, List<Object> createdElements, List<AtlasEdge> deletedElements, List<Object> currentElements) {
        ...
        if (CollectionUtils.isNotEmpty(createdElements)) {
            ...
            addedGuids.forEach(guid -> AtlasGraphUtilsV3.addEncodedProperty(toVertex, internalAttr, guid));
        }
        ...
        if (CollectionUtils.isNotEmpty(deletedElements)) {
            ...
            removedGuids.forEach(guid -> AtlasGraphUtilsV3.removeItemFromListPropertyValue(toVertex, internalAttr, guid));
        }
    ...
    private boolean shouldDeleteExistingRelations(AttributeMutationContext ctx, AtlasAttribute attribute) {
        boolean ret = false;
        AtlasEntityType entityType = typeRegistry.getEntityTypeByName(AtlasGraphUtilsV3.getTypeName(ctx.getReferringVertex()));
            ...
            try {
                if (StringUtils.isNotEmpty(entityGuid)) {
                    ...
                    if (entityType != null && MapUtils.isNotEmpty(entityObject.getUniqueAttributes())) {
                        referredVertex = AtlasGraphUtilsV3.findByUniqueAttributes(this.graph, entityType, entityObject.getUniqueAttributes());
                    }
                }
    ...
    private void addGlossaryAttr(AttributeMutationContext ctx, AtlasEdge edge) {
        ...
        if (TYPE_TERM.equals(toVertexType) || TYPE_CATEGORY.equals(toVertexType)) {
            ...
            AtlasGraphUtilsV3.setEncodedProperty(toVertex, GLOSSARY_PROPERTY_KEY, gloQname);
        }
        RequestContext.get().endMetricRecord(metricRecorder);
    }
    ...
    private void addCatParentAttr(AttributeMutationContext ctx, AtlasEdge edge) {
        ...
        if (TYPE_CATEGORY.equals(toVertexType)) {
            if (edge == null) {
                ...
                AtlasGraphUtilsV3.setEncodedProperty(toVertex, CATEGORIES_PARENT_PROPERTY_KEY, parentQName);
            }
        }
        RequestContext.get().endMetricRecord(metricRecorder);
    }
    ...
    private void addCatParentAttr(AttributeMutationContext ctx, List<Object> newElementsCreated, List<AtlasEdge> removedElements) {
        ...
        if (CollectionUtils.isNotEmpty(newElementsCreated)) {
            ...
            catVertices.stream().forEach(v -> AtlasGraphUtilsV3.setEncodedProperty(v, CATEGORIES_PARENT_PROPERTY_KEY, parentQName));
        }
    ...
    private void addCategoriesToTermEntity(AttributeMutationContext ctx, List<Object> newElementsCreated, List<AtlasEdge> removedElements) {
        ...
        if (TYPE_CATEGORY.equals(getTypeName(termVertex))) {
            ...
            if (CollectionUtils.isNotEmpty(newElementsCreated)) {
                ...
                termVertices.stream().forEach(v -> AtlasGraphUtilsV3.addEncodedProperty(v, CATEGORIES_PROPERTY_KEY, catQName));
            }

            if (CollectionUtils.isNotEmpty(removedElements)) {
                List<AtlasVertex> termVertices = removedElements.stream().map(x -> x.getInVertex()).collect(Collectors.toList());
                termVertices.stream().forEach(v -> AtlasGraphUtilsV3.removeItemFromListPropertyValue(v, CATEGORIES_PROPERTY_KEY, catQName));
            }
        }
        ...
        if (TYPE_TERM.equals(getTypeName(termVertex))) {
            ...
            catQnames.stream().forEach(q -> AtlasGraphUtilsV3.addEncodedProperty(termVertex, CATEGORIES_PROPERTY_KEY, q));
        }
        RequestContext.get().endMetricRecord(metricRecorder);
    }
    ...
    private void addMeaningsToEntity(AttributeMutationContext ctx, List<Object> createdElements, List<AtlasEdge> deletedElements) {
        ...
        if (CollectionUtils.isNotEmpty(qNames)) {
            qNames.forEach(q -> AtlasGraphUtilsV3.addEncodedProperty(ctx.getReferringVertex(), MEANINGS_PROPERTY_KEY, q));
        }

        if (CollectionUtils.isNotEmpty(names)) {
            AtlasGraphUtilsV3.setEncodedProperty(ctx.referringVertex, MEANINGS_TEXT_PROPERTY_KEY, StringUtils.join(names, ","));
        }

        if (CollectionUtils.isNotEmpty(newMeaningsNames)) {
            newMeaningsNames.forEach(q -> AtlasGraphUtilsV3.addListProperty(ctx.getReferringVertex(), MEANING_NAMES_PROPERTY_KEY, q, true));
        }
        ...
        if(createdElements.isEmpty()){
            ...
            deletedMeaningsNames.forEach(q -> AtlasGraphUtilsV3.removeItemFromListPropertyValue(ctx.getReferringVertex(), MEANING_NAMES_PROPERTY_KEY, q));
    ...
    private boolean getAppendOptionForRelationship(AtlasVertex entityVertex, String relationshipAttributeName) {
        boolean                             ret                       = false;
        String                              entityTypeName            = AtlasGraphUtilsV3.getTypeName(entityVertex);
    ...
    private AtlasEdge createVertex(AtlasStruct struct, AtlasVertex referringVertex, String edgeLabel, EntityMutationContext context) throws AtlasBaseException {
        ...
        try {
            ...
            return graphHelperV3.getOrCreateEdge(referringVertex, vertex, edgeLabel);
        } catch (RepositoryException e) {
            throw new AtlasBaseException(AtlasErrorCode.INTERNAL_ERROR, e);
        }
    }
        ...
        if (val != null) {
            ...
            if (val instanceof AtlasObjectId) {
                ...
                if (StringUtils.isNotEmpty(guid)) {
                    ...
                    if (vertex != null) {
                        assignedGuid = graphHelperV3.getGuid(vertex);
                    }
                }
            ...
            if (typeName == null) {
                if (guid != null) {
                    ...
                    if (ret == null) {
                        ...
                        if (vertex != null) {
                            typeName = AtlasGraphUtilsV3.getTypeName(vertex);
                        }
                    }
                }
            }
    ...
    private AtlasEdge updateEdge(AtlasAttributeDef attributeDef, Object value, AtlasEdge currentEdge, final AtlasVertex entityVertex) throws AtlasBaseException {
        ...
        if (!currentEntityId.equals(newEntityId) && entityVertex != null) {
            try {
                newEdge = graphHelperV3.getOrCreateEdge(currentEdge.getOutVertex(), entityVertex, currentEdge.getLabel());
            } catch (RepositoryException e) {
                throw new AtlasBaseException(AtlasErrorCode.INTERNAL_ERROR, e);
            }
        }
    ...
    private AtlasEdge updateRelationship(AtlasEdge currentEdge, final AtlasVertex parentEntityVertex, final AtlasVertex newEntityVertex,
        ...
        if (StringUtils.isEmpty(currentEntityId) || !currentEntityId.equals(newEntityId)) {
            ...
            String relationshipName = AtlasGraphUtilsV3.getTypeName(currentEdge);
            ...
            if (isArrayOfPrimitiveType || isArrayOfEnum) {
                ...
                if (CollectionUtils.isNotEmpty(allValues)) {
                    for (Object value: allValues) {
                        AtlasGraphUtilsV3.addEncodedProperty(vertex, vertexPropertyName, value);
                    }
                }
            } else {
                AtlasGraphUtilsV3.setEncodedProperty(vertex, vertexPropertyName, allValues);
            }
        }
    }
    ...
    private void updateInConsistentOwnedMapVertices(AttributeMutationContext ctx, AtlasMapType mapType, Object val) {
        if (mapType.getValueType().getTypeCategory() == TypeCategory.OBJECT_ID_TYPE && !ctx.getAttributeDef().isSoftReferenced()) {
            ...
            if (ctx.getAttribute().isOwnedRef() && getStatus(edge) == DELETED && getStatus(edge.getInVertex()) == DELETED) {
                ...
                AtlasGraphUtilsV3.setEncodedProperty(edge.getInVertex(), STATE_PROPERTY_KEY, ACTIVE.name());
            }
        }
    }
    ...
    public void cleanUpClassificationPropagation(String classificationName, int batchLimit) {
        ...
        Iterator<AtlasVertex> tagVertices = GraphHelperV3.getClassificationVertices(graph, classificationName, CLEANUP_BATCH_SIZE);
        ...
        while (tagVertices != null && tagVertices.hasNext()) {
            ...
            while (tagVertices.hasNext() && currentAssetVerticesBatch.size() < CLEANUP_BATCH_SIZE) {
                ...
                long assetCountForCurrentTagVertex = GraphHelperV3.getAssetsCountOfClassificationVertex(tagVertex);
                currentAssetVerticesBatch.addAll(GraphHelperV3.getAllAssetsWithClassificationVertex(tagVertex, availableSlots));
                ...
                do {
                    try {
                        ...
                        for (AtlasVertex vertex : entityVertices) {
                            ...
                            GraphTransactionInterceptor.lockObjectAndReleasePostCommit(graphHelperV3.getGuid(vertex));
                            List<AtlasEdge> classificationEdges = GraphHelperV3.getClassificationEdges(vertex, null, classificationName);
            ...
            tagVertices = GraphHelperV3.getClassificationVertices(graph, classificationName, CLEANUP_BATCH_SIZE);
        }
    ...
    public AtlasEntity repairClassificationMappings(AtlasVertex entityVertex) throws AtlasBaseException {
        ...
        for(String classificationName : classificationNames) {
            AtlasGraphUtilsV3.addEncodedProperty(entityVertex, TRAIT_NAMES_PROPERTY_KEY, classificationName);
        }
        ...
        if (CollectionUtils.isNotEmpty(classifications)) {
            ...
            for (AtlasClassification c : classifications) {
                ...
                if (removePropagations == null) {
                    removePropagations = graphHelperV3.getDefaultRemovePropagations();
    ...
    public List<String> propagateClassification(String entityGuid, String classificationVertexId, String relationshipGuid, Boolean previousRestrictPropagationThroughLineage,Boolean previousRestrictPropagationThroughHierarchy) throws AtlasBaseException {
        try {
            ...
            AtlasVertex entityVertex = graphHelperV3.getVertexForGUID(entityGuid);
            if (entityVertex == null) {
            ...
            Boolean currentRestrictPropagationThroughLineage = AtlasGraphUtilsV3.getProperty(classificationVertex, CLASSIFICATION_VERTEX_RESTRICT_PROPAGATE_THROUGH_LINEAGE, Boolean.class);

            Boolean currentRestrictPropagationThroughHierarchy = AtlasGraphUtilsV3.getProperty(classificationVertex, CLASSIFICATION_VERTEX_RESTRICT_PROPAGATE_THROUGH_HIERARCHY, Boolean.class);
    ...
    public List<String> processClassificationPropagationAddition(List<AtlasVertex> verticesToPropagate, AtlasVertex classificationVertex) throws AtlasBaseException{
        ...
        try {
            do {
                ...
                MetricRecorder metricRecorder  = RequestContext.get().startMetricRecord("lockObjectsAfterTraverse");
                List<String> impactedVerticesGuidsToLock        = chunkedVerticesToPropagate.stream().map(x -> GraphHelperV3.getGuid(x)).collect(Collectors.toList());
    ...
    public void deleteClassification(String entityGuid, String classificationName) throws AtlasBaseException {
        ...
        AtlasVertex         classificationVertex = getClassificationVertex(graphHelperV3, entityVertex, classificationName);
                ...
                if (CollectionUtils.isNotEmpty(entityTaskGuids)) {
                    ...
                    if (pendingTaskExists) {
                        ...
                        for (AtlasTask entityClassificationPendingTask: entityClassificationPendingTasks) {
                            ...
                            AtlasGraphUtilsV3.deleteProperty(entityVertex, PENDING_TASKS_PROPERTY_KEY, taskGuid);
//                            propagateDelete = false;  TODO: Uncomment when all unnecessary ADD tasks are resolved
    ...
    private AtlasEntity updateClassificationText(AtlasVertex vertex) throws AtlasBaseException {
        String guid        = graphHelperV3.getGuid(vertex);
    ...
    public void updateClassifications(EntityMutationContext context, String guid, List<AtlasClassification> classifications) throws AtlasBaseException {
        ...
        for (AtlasClassification classification : classifications) {
            ...
            if (updatedRemovePropagations != null && !updatedRemovePropagations.equals(currentRemovePropagations)) {
                AtlasGraphUtilsV3.setEncodedProperty(classificationVertex, CLASSIFICATION_VERTEX_REMOVE_PROPAGATIONS_KEY, updatedRemovePropagations);
                isClassificationUpdated = true;
            ...
            if (isClassificationUpdated) {
                List<AtlasVertex> propagatedEntityVertices = graphHelperV3.getAllPropagatedEntityVertices(classificationVertex);
        ...
        for (AtlasVertex vertex : notificationVertices) {
            String      entityGuid = graphHelperV3.getGuid(vertex);
    ...
    private AtlasEdge mapClassification(EntityOperation operation,  final EntityMutationContext context, AtlasClassification classification,
        ...
        if (classification.getValidityPeriods() != null) {
            ...
            AtlasGraphUtilsV3.setEncodedProperty(traitInstanceVertex, CLASSIFICATION_VALIDITY_PERIODS_KEY, strValidityPeriods);
        } else {
            // if 'null', don't update existing value in the classification
        }

        if (classification.isPropagate() != null) {
            AtlasGraphUtilsV3.setEncodedProperty(traitInstanceVertex, CLASSIFICATION_VERTEX_PROPAGATE_KEY, classification.isPropagate());
        }

        if (classification.getRemovePropagationsOnEntityDelete() != null) {
            AtlasGraphUtilsV3.setEncodedProperty(traitInstanceVertex, CLASSIFICATION_VERTEX_REMOVE_PROPAGATIONS_KEY, classification.getRemovePropagationsOnEntityDelete());
        }

        if(classification.getRestrictPropagationThroughLineage() != null){
            AtlasGraphUtilsV3.setEncodedProperty(traitInstanceVertex, CLASSIFICATION_VERTEX_RESTRICT_PROPAGATE_THROUGH_LINEAGE, classification.getRestrictPropagationThroughLineage());
        }

        if(classification.getRestrictPropagationThroughHierarchy() != null){
            AtlasGraphUtilsV3.setEncodedProperty(traitInstanceVertex, CLASSIFICATION_VERTEX_RESTRICT_PROPAGATE_THROUGH_HIERARCHY, classification.getRestrictPropagationThroughHierarchy());
        }
        ...
        if (ret == null) {
            ret = graphHelperV3.addClassificationEdge(parentInstanceVertex, traitInstanceVertex, false);
        }
    ...
    public void deleteClassifications(String guid) throws AtlasBaseException {
        AtlasVertex instanceVertex = AtlasGraphUtilsV3.findByGuid(this.graph, guid);
    ...
    public void updateClassificationTextPropagation(String classificationVertexId) throws AtlasBaseException {
        ...
        List<AtlasVertex> impactedVertices = graphHelperV3.getAllPropagatedEntityVertices(classificationVertex);
    ...
    public void deleteClassificationOnlyPropagation(Set<String> deletedEdgeIds) throws AtlasBaseException {
        ...
        for (AtlasEdge edge : deletedEdgeIds.stream().map(x -> graph.getEdge(x)).collect(Collectors.toList())) {
            ...
            String  relationshipGuid   = GraphHelperV3.getRelationshipGuid(edge);
    ...
    public void deleteClassificationOnlyPropagation(String classificationId, String referenceVertexId, boolean isTermEntityEdge) throws AtlasBaseException {
        ...
        if (!GraphHelperV3.propagatedClassificationAttachedToVertex(classificationVertex, referenceVertex)) {
    ...
    public void classificationRefreshPropagation(String classificationId) throws AtlasBaseException {
        ...
        Boolean restrictPropagationThroughLineage = AtlasGraphUtilsV3.getProperty(currentClassificationVertex, CLASSIFICATION_VERTEX_RESTRICT_PROPAGATE_THROUGH_LINEAGE, Boolean.class);
        Boolean restrictPropagationThroughHierarchy = AtlasGraphUtilsV3.getProperty(currentClassificationVertex, CLASSIFICATION_VERTEX_RESTRICT_PROPAGATE_THROUGH_HIERARCHY, Boolean.class);
        ...
        List<String> propagatedVerticesIds = GraphHelperV3.getPropagatedVerticesIds(currentClassificationVertex);
        ...
        try {
            do {
                ...
                List<String> impactedGuids = verticesChunkToRemoveTag.stream()
                        .map(entityVertex -> GraphHelperV3.getGuid(entityVertex))
                        .collect(Collectors.toList());
    ...
    List<String> processClassificationEdgeDeletionInChunk(AtlasClassification classification, List<AtlasEdge> propagatedEdges) throws AtlasBaseException {
        ...
        do {
            ...
            List<String> impactedGuids = entityVertices.stream().map(x -> GraphHelperV3.getGuid(x)).collect(Collectors.toList());
    ...
    private void recordEntityUpdate(AtlasVertex vertex) throws AtlasBaseException {
        if (vertex != null) {
            ...
            if (!req.isUpdatedEntity(graphHelperV3.getGuid(vertex))) {
                updateModificationMetadata(vertex);
    ...
    public void importActivateEntity(AtlasVertex vertex, AtlasEntity entity) {
        AtlasGraphUtilsV3.setEncodedProperty(vertex, STATE_PROPERTY_KEY, ACTIVE);
    ...
    private void activateEntityRelationships(AtlasVertex vertex, Set<String> relatedEntitiesGuids) {
        ...
        while (edgeIterator.hasNext()) {
            ...
            if (Objects.equals(edge.getInVertex().getId(), vertex.getId())) {
                relatedEntityGuid = getIdFromVertex(edge.getOutVertex());
            } else {
                relatedEntityGuid = getIdFromVertex(edge.getInVertex());
            }
            ...
            for (AtlasBusinessAttribute bmAttribute : entityTypeBusinessAttributes.values()) {
                ...
                if (attrValue != null) {
                    ...
                    if (isOverwrite) {
                        ...
                        Object existingValue = AtlasGraphUtilsV3.getEncodedProperty(entityVertex, bmAttribute.getVertexPropertyName(), Object.class);
    ...
    List<AtlasEntity> updateClassificationText(AtlasClassification classification, Collection<AtlasVertex> propagatedVertices) throws AtlasBaseException {
        ...
        MetricRecorder metricRecorder = RequestContext.get().startMetricRecord("updateClassificationText");
        ...
        if(CollectionUtils.isNotEmpty(propagatedVertices)) {
            for(AtlasVertex vertex : propagatedVertices) {
                ...
                for (int i = 1; i <= MAX_NUMBER_OF_RETRIES; i++) {
                    try {
                        entity = instanceConverter.getAndCacheEntity(graphHelperV3.getGuid(vertex), ENTITY_CHANGE_NOTIFY_IGNORE_RELATIONSHIP_ATTRIBUTES);
    ...
    private void updateLabels(AtlasVertex vertex, Set<String> labels) {
        if (CollectionUtils.isNotEmpty(labels)) {
            AtlasGraphUtilsV3.setEncodedProperty(vertex, LABELS_PROPERTY_KEY, getLabelString(labels));
        } else {
    ...
    public void removePendingTaskFromEdge(String edgeId, String taskGuid) throws AtlasBaseException {
        ...
        AtlasGraphUtilsV3.removeItemFromListProperty(edge, EDGE_PENDING_TASKS_PROPERTY_KEY, taskGuid);
    }
        ...
        for (AtlasEdge atlasEdge : inputOutputEdges) {
            ...
            while (oppositeEdges.hasNext()) {
                ...
                if (getStatus(oppositeEdge) == ACTIVE && getStatus(oppositeEdgeAssetVertex) == ACTIVE) {
                    ...
                    if (isRestoreEntity) {
                        AtlasGraphUtilsV3.setEncodedProperty(oppositeEdgeAssetVertex, HAS_LINEAGE, true);
                    } else {
                        break;
                    }
                }
    ...
    public List<AtlasVertex> unlinkBusinessPolicy(String policyId, Set<String> unlinkGuids) {
        ...
        return unlinkGuids.stream()
                .map(guid -> AtlasGraphUtilsV3.findByGuid(graph, guid))
    ...
    public List<AtlasVertex> unlinkMeshEntityFromAssets(String meshEntityId, Set<String> unlinkGuids) throws AtlasBaseException {
        ...
        for (String guid : unlinkGuids) {
            AtlasVertex ev = AtlasGraphUtilsV3.findByGuid(graph, guid);
    ...
    public AtlasVertex moveBusinessPolicies(Set<String> policyIds, String assetId, String type) throws AtlasBaseException {
        ...
        AtlasVertex assetVertex = AtlasGraphUtilsV3.findByGuid(graph, assetId);
