...
public class EntityDiscoveryService implements AtlasDiscoveryService {
    ...
    private void prepareSearchResultV1(AtlasSearchResult ret, DirectIndexQueryResult indexQueryResult, Set<String> resultAttributes,
        ...
        AtlasPerfMetrics.MetricRecorder prepareSearchResultMetrics = RequestContext.get().startMetricRecord("prepareSearchResultV1");
        try {
            if(LOG.isDebugEnabled()){
                LOG.debug("Preparing search results v1 for ({})", ret.getSearchParameters());
            }
            Iterator<Result> iterator = indexQueryResult.getIterator();
