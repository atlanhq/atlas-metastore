...
public class KafkaNotification extends AbstractNotification implements Service {
    ...
    public    static final String ATLAS_AUTH_POLICY_TASKS_TOPIC = AtlasConfiguration.NOTIFICATION_AUTH_POLICY_TASKS_TOPIC_NAME.getString();
    ...
    private static final Map<NotificationType, String> PRODUCER_TOPIC_MAP = new HashMap<NotificationType, String>() {
        {
            ...
            put(NotificationType.AUTH_POLICY_TASKS, ATLAS_AUTH_POLICY_TASKS_TOPIC);
        }
    };
