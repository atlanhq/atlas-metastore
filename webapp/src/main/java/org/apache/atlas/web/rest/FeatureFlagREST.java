...
public class FeatureFlagREST {
    ...
    @GET
    @Timed
    public FeatureFlagListResponse getAllFeatureFlags() throws AtlasBaseException {
    ...
    @Path("{key}")
    @Timed
    public FeatureFlagInfo getFeatureFlag(@PathParam("key") String key) throws AtlasBaseException {
        if (LOG.isDebugEnabled()) {
