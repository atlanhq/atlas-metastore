...
public abstract class AbstractParam<T> {
     ...
     * a {@link jakarta.ws.rs.core.Response} to be sent to the client.
     *
     ...
     * @return the {@link jakarta.ws.rs.core.Response} to be sent to the client
     */
    ...
    /**
     * Given a string representation which was unable to be parsed, produce a {@link jakarta.ws.rs
     * .core.Response.Status} for the
     * {@link Response} to be sent to the client.
     *
     * @return the HTTP {@link jakarta.ws.rs.core.Response.Status} of the error message
     */
