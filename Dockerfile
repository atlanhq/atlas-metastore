...
RUN wget https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/download/v2.14.0/opentelemetry-javaagent.jar -o /opt/apache-atlas/otel-agent/opentelemetry-javaagent.jar
