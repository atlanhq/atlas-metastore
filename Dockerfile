...
#Cassandra keyspaces for context_engine and atlas_context_janusgraph are in application.yaml
...
# Expose Atlas REST API port along with context engine REST API 
