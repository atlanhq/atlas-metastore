...
//        when(resourceObject.queryParam(anyString(), anyString())).thenReturn(resourceObject);
...
//        when(resourceBuilderMock.header(anyString(), anyString())).thenReturn(resourceBuilderMock);
