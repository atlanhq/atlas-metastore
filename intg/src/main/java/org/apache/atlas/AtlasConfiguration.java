...
public enum AtlasConfiguration {
    ...
    ATLAS_INDEXSEARCH_EDGE_BULK_FETCH_BATCH_SIZE ("atlas.indexsearch.edge.bulk.fetch.batch.size", 100),
    ATLAS_INDEXSEARCH_REF_VERTEX_CACHE_TTL_SECONDS("atlas.indexsearch.reference.vertex.cache.ttl.seconds", 60),
    ATLAS_INDEXSEARCH_REF_VERTEX_CACHE_MAX_SIZE("atlas.indexsearch.reference.vertex.cache.max.size", 10000),
