...
public enum AtlasConfiguration {
    ...
    // Ingestion dump configuration
    INGESTION_DUMP_THREADS("atlas.ingestion.dump.threads", 10),
    INGESTION_DUMP_QUEUE_SIZE("atlas.ingestion.dump.queue.size", 100),
    INGESTION_DUMP_KEYSPACE("atlas.ingestion.dump.cassandra.keyspace", "atlas_ingest");
